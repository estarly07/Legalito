...
class DocumentsSearchBloc
    extends Bloc<DocumentsSearchEvent, DocumentsSearchState> {
  final DocumentsGeminiService _documentsGeminiService;

  DocumentsSearchBloc(this._documentsGeminiService)
      : super(DocumentsSearchInitial()) {
  ...
  Future<void> _onSearchDocuments(
    ...
    try {
      final documents =
          await _documentsGeminiService.fetchRelatedDocuments(event.query);
